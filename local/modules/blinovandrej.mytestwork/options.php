...
$aTabs = array(
	array(
		...
		"OPTIONS" => array(
			...
			array(
				"iblockCreated",
				Loc::getMessage("MODULE_OPTIONS_IBLOCKID"),
				Option::get("blinovandrej.mytestwork", "iblockCreated"),
				array("text", 10)
			),
           	array(
				"webhkUrl",
				Loc::getMessage("MODULE_OPTIONS_WEBHUK"),
				Option::get("blinovandrej.mytestwork", "webhkUrl"),
				array("text", 100)
			),
		)
	)
